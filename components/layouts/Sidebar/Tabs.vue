...
<template>
  <div class="flex flex-col p-3 overflow-y-hidden hover:overflow-y-auto active:overflow-y-auto focus:overflow-y-auto h-full">
    <div v-for="category in categories" :key="category.id">
      ...
      <div class="mt-1">
        <div v-for="tab in category.channels" :key="tab.id" class="text-gray-600 text-sm flex items-center gap-2 px-3 rounded-lg py-2 cursor-pointer hover:bg-gray-100">
